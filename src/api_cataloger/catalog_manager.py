...
class CatalogManager:
    ...
    def scan_directory(
        self, directory: Path, team_owner: Optional[str] = None, recursive: bool = True
    ) -> APICatalog:
        ...
        for file_path in files:
            ...
            if any(
                ...
                for exclude in ["node_modules", "__pycache__", "venv", "dist", "build"]
            ):
                continue
    ...
    def parse_files(
        self, file_paths: List[Path], team_owner: Optional[str] = None
    ) -> APICatalog:
